...
import event from "../../assets/Pages/sports.mp4";
    ...
    <div className="bg-[#1A1A1A] mt-[4rem]">
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between w-4/5 mx-auto space-y-6 md:space-y-0 md:space-x-6">
          ...
          >
            SPOORTHI <br />
            Unleash your competitive spirit in our action-packed sports
            festival.
          </h1>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-4/5 mx-auto space-x-6">
          ...
          >
            <h1 className="text-white text-2xl md:text-4xl font-bold">
              About Our Sports Fest
            </h1>
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              Welcome to Spoorthi, our Sports Fest brings together tech
              enthusiasts and athletes for a perfect blend of competition and
              camaraderie. Featuring multiple sports tournaments, team events,
              and exciting prizes.
            </p>
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              From cricket to basketball, football to athletics, there's
              something for everyone at our annual sports extravaganza.
            </p>
          </div>
