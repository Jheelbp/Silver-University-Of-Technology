...
import event from "../../assets/Pages/techtalk.mp4";
import techtalks from "../../assets/Pages/techtalkpattern.png";
    ...
    <div className="bg-[#1A1A1A] mt-[4rem]">
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between w-4/5 mx-auto space-y-6 md:space-y-0 md:space-x-6">
          <img
            src={techtalks}
            className="h-[18rem] md:h-[20rem] w-[26rem]"
            alt="Design"
          />
          <h1
            ref={headerTextRef}
          ...
          >
            TECH TALKS <br />
            Inspiring conversations with industry leaders shaping the future of
            technology.
          </h1>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-4/5 mx-auto space-x-6">
          ...
          >
            ...
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              Our Tech Talks series features thought leaders, innovators, and
              experts sharing insights on emerging technologies, career growth,
              and industry trends.
            </p>
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              Join interactive sessions, Q&As, and networking opportunities with
              speakers from leading tech companies and startups.
            </p>
          </div>
