...
import event from "../../assets/Pages/event.mp4";
import hackathon from "../../assets/Pages/hackathon.jpeg";
...
const Aurora = () => {
  ...
  return (
    <div className="bg-[#1A1A1A] mt-[4rem]">
      {/* Header Section */}
      <div ref={headerRef} className="flex bg-[#1A1A1A] h-[25rem] mt-[4rem]">
        <img src={design} className="h-full w-1/2 object-cover" alt="Design" />
        <div
          ref={headerContentRef}
          className="flex flex-col w-1/2 p-4 text-black"
        >
          <h1 className="text-3xl text-white font-bold mt-8">Events</h1>
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between w-4/5 mx-auto space-y-6 md:space-y-0 md:space-x-6">
          ...
          >
            AURORA <br />
            Where innovation meets code - 24 hours of non-stop creativity and
            problem-solving.
          </h1>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-4/5 mx-auto space-x-6">
          ...
          >
            <h1 className="text-white text-2xl md:text-4xl font-bold">
              About Our Cultural Fest
            </h1>
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              Welcome to Aurora, where creativity meets innovation. Our mission
              is to bring together brilliant minds, foster collaboration, and
              create experiences that inspire and empower.
            </p>
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              Join us on this exciting journey as we explore the realms of art,
              technology, and culture. Together, let's shape the future with
              passion and purpose.
            </p>
          </div>
        ...
        >
          ...
          <div className="box-content relative z-10 p-6 flex flex-col items-center justify-between">
            ...
            <p className="text-base text-gray-300 mb-4">
              Join 24 hours of brainstorming and explore new ways to express
              your ideas through art and technology.
            </p>
            <div className="w-full flex flex-wrap justify-around items-center py-12 space-x-4 space-y-4">
              <button
